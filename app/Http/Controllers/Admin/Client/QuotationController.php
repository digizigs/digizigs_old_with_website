...
class QuotationController extends Controller
{
    ...
    {   
        //$data = 'test';
        //return $pdf = PDF::loadView('admin.pages.client.quotation', $data);

        //$data = ['title' => 'Welcome to HDTuto.com'];
        //$pdf = PDF::loadView('app/Views/test', $data);
    ...
    public function create(Request $request) {
        ...
        if($data == ''){
            ...
            $invoices['data'] = Invoice::where('type','quotation')->with('client','invoice_item.service')
    ...
    public function store(Request $request) {
        ...
        if($saved){
            $invoices = Invoice::orderby('created_at','desc')->where('type','quotation')->with('client','invoice_item.service')->paginate(7);
            return request()->json(200,$invoices);
        }
