...
namespace App\Http\Controllers\AppAdmin\Post;
...
class PostController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if($request->has('posts_type')){
            ...
            if($post_type === 'published'){
                ...
                return view('appadmin.pages.post.allpost',compact('posts'));
    ...
    public function create() {
        ...
        return view('appadmin.pages.post.newpost',compact('categories'));
    }
