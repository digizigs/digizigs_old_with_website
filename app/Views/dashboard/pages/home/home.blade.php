                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card card-body">
                      ...
                      <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        ...
                        <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-success">1.2% <i class=""></i></span> than last week</p>
                      </div>
                ...
                <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
                    <div class="card card-body">
                      ...
                      <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        ...
                        <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-danger">0.7% <i class=""></i></span> than last week</p>
                      </div>
                      <div class="chart-three">
                ...
                <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
                    <div class="card card-body">
                      ...
                      <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        ...
                        <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-danger">0.3% <i class=""></i></span> than last week</p>
                      </div>
                      <div class="chart-three">
                ...
                <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
                    <div class="card card-body">
                      ...
                      <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        ...
                        <p class="tx-11 tx-color-03 mg-b-0"><span class="tx-medium tx-success">2.1% <i class=""></i></span> than last week</p>
                      </div>
                      <div class="chart-three">
                    ...
                    <div class="card ht-lg-100p">
                      <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="tx-13 d-flex align-items-center">
                          <span class="mg-r-5">Country:</span> <a href="#" class="d-flex align-items-center link-03 lh-0">USA <i class=""></i></a>
                        </div>
                      </div><!-- card-header -->
                        ...
                        <table class="table table-dashboard mg-b-0">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td class="tx-medium text-right">$28,670.90 <span class="mg-l-5 tx-10 tx-normal tx-success"><i class=""></i> 4.5%</span></td>
                            </tr>
                            <tr>
                              ...
                              <td class="tx-medium text-right">$26,930.40  <span class="mg-l-5 tx-10 tx-normal tx-danger"><i class=""></i> 0.8%</span></td>
                            </tr>
                            <tr>
                              <td class="tx-color-03 tx-normal">03/04/2018</td>
                              <td class="tx-medium text-right">980</td>
                    ...
                    <div class="card ht-100p">
                      <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex tx-18">
                          <a href="#" class="link-03 lh-0"><i class=""></i></a>
                          <a href="#" class="link-03 lh-0 mg-l-10"><i class=""></i></a>
                        </div>
                      </div>
                      <ul class="list-group list-group-flush tx-13">
                        <li class="list-group-item d-flex pd-sm-x-20">
                          <div class="avatar d-none d-sm-block"><span class="avatar-initial rounded-circle bg-teal"><i class=""></i></span></div>
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                          <div class="avatar d-none d-sm-block"><span class="avatar-initial rounded-circle bg-indigo op-5"><i class=""></i></span></div>
                          <div class="pd-sm-l-10">
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                          <div class="avatar d-none d-sm-block"><span class="avatar-initial rounded-circle bg-orange op-5"><i class=""></i></span></div>
                          <div class="pd-sm-l-10">
                        ...
                        <li class="list-group-item d-flex pd-sm-x-20">
                          <div class="avatar d-none d-sm-block"><span class="avatar-initial rounded-circle bg-gray-400"><i class=""></i></span></div>
                          <div class="pd-sm-l-10">
                      ...
                      <div class="card-footer text-center tx-13">
                        <a href="#" class="link-03">View All Transactions <i class=""></i></a>
                      </div><!-- card-footer -->
                    </div><!-- card -->
                </div>
                    ...
                    <div class="card ht-100p">
                      ...
                      <ul class="list-group list-group-flush tx-13">
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                          <div class="avatar"><img src="{{asset('public/dashboard/assets/img/img23.jpg')}}" class="rounded-circle" alt=""></div>
                          <div class="pd-l-10">
                        ...
                        <li class="list-group-item d-flex pd-x-20">
                          <div class="avatar"><img src="{{asset('public/dashboard/assets/img/img16.jpg')}}" class="rounded-circle" alt=""></div>
                          <div class="pd-l-10">
                      ...
                      <div class="card-footer text-center tx-13">
                        <a href="#" class="link-03">View More Customers <i class=""></i></a>
                      </div><!-- card-footer -->
                    </div><!-- card -->
                </div>
                    ...
                    <div class="card ht-lg-100p">
                      ...
                      <div class="card-body pd-b-0">
                        <div class="row mg-b-20">
                          <div class="col">
                            <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">$150,200 <small class="tx-11 tx-success letter-spacing--2"><i class=""></i> 0.20%</small></h4>
                            <p class="tx-11 tx-uppercase tx-spacing-1 tx-medium tx-color-03">Total Sales</p>
                          </div>
                          <div class="col">
                            <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-10">$21,880 <small class="tx-11 tx-danger letter-spacing--2"><i class=""></i> 1.04%</small></h4>
