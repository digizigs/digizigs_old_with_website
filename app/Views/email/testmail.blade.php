          ...
          <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
              ...
              <td class="bg_dark email-section" style="text-align:center; padding:20px;">
                  <div class="heading-section heading-section-white">
                      <span class="subheading">
                        <img width="100" border="0" style="display: block; width: 100px;padding:10px;" src="{{asset('public/images/brand_assets/DZ-Logo Orange-white.png')}}" alt="DigiZigs" />
                      </span>
                  </div>
              </td>
            </tr><!-- end: tr -->
            ...
            <tr>
              <td class="bg_white email-section">
                  <div class="heading-section" style="text-align: center; padding: 40px 30px;">
            ...
            <tr>
              <td class="bg_white email-section">
                <div class="heading-section" style="text-align: center; padding: 20 30px;">
            ...
            <tr>
              <td class="bg_white email-section" style="padding: 0; width: 100%;">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
