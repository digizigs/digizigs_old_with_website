    ...
    <script src="{{asset('public/vendor/bootstrap-wysiwyg/js/bootstrap-wysiwyg.min.js')}}"></script>
    ...
    <script src="{{asset('public/vendor/select2/dist/js/select2.full.min.js')}}"></script>
    <script src="{{asset('public/vendor/switchery/dist/switchery.min.js')}}"></script>
    <script src="{{asset('public/vendor/google-code-prettify/src/prettify.js')}}"></script>
    <script src="{{asset('public/vendor/jquery.tagsinput/src/jquery.tagsinput.js')}}"></script>
    <script src="{{asset('public/vendor/parsleyjs/dist/parsley.min.js')}}"></script>
    <script src="{{asset('public/vendor/autosize/dist/autosize.min.js')}}"></script>
    <script src="{{asset('public/vendor/devbridge-autocomplete/dist/jquery.autocomplete.min.js')}}"></script>
    <script src="{{asset('public/vendor/starrr/dist/starrr.js')}}"></script-->
