<template>
    <div class="mat-card">
        ...
        <div id="blockchart" class="card-block">
            ...
            <barlinechartjs v-if="this.charttype == 'barline'" :chartData="datacollection" :options="chartOptions"></barlinechartjs>
        </div>
    </div>
</template>
    ...
    export default{
        ...
        watch:{
            dataset:function(){
                ...
                this.device = this.dataset.map(x => x[0])
                this.sessions = this.dataset.map(x => x[2])
                this.pageviews = this.dataset.map(x => x[3])
                this.duration = this.dataset.map(x => x[4])
