 <div id="app">  
    ...
    <header class="main-menu" id="home">
            ...
            <div id="myCarousel" class="carousel slide carousel-fade">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="fill" style="background-image:url(http://www.digizigs.com/public/images/web/slider/11.jpg)"></div>
                        <div class="caption">
                    ...
                    <div class="item">
                        <div class="fill" style="background-image:url(http://www.digizigs.com/public/images/web/slider/22.jpg)"></div>
                        <div class="caption">
                            <h1>
                                <span   class="txt-rotate" 
                                        data-period="2000" 
                    ...
                    <div class="item">
                        <div class="fill" style="background-image:url(http://www.digizigs.com/public/images/web/slider/33.jpg)"></div>
                        <div class="caption">
                            <h1>
                                <span   class="txt-rotate" 
                                        data-period="2000" 
        ...
        <div class="main-nav">
            ...
            <!--Web Branding-->
            <div class="branding">
                <a href="http://www.digizigs.com"><img src="http://www.digizigs.com/public/images/DigiZigs_new_2.png" alt="" style="width: 200px;"></a>
            </div>
    ...
    <!--Features-->
    <section id="features" class="" style="background: url(http://www.digizigs.com/public/images/web/features/poster.jpg);">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-4 hidden-sm hidden-xs ">
                    <div class="feature-image">
                        <img src="http://www.digizigs.com/public/images/web/features/animation-rocket.gif" class="pos-hcenter img-responsive " alt="">
                    </div>
                </div>
            ...
            <div class="row mp0">
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 ">
                    <div class="text-icon-box mb50 center wow fadeInUp padding20 box-hover-1" data-wow-delay="0.1s">
                        <div class="box-img-icon features-box-icon">
                            <img src="http://www.digizigs.com/public/images/web/features/design-tool.svg" alt="">
                        </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 ">
                    <div class="text-icon-box relative mb50 center  wow fadeInUp padding20 box-hover-1" data-wow-delay="0.2s">
                        <div class="box-img-icon features-box-icon">
                            <img src="http://www.digizigs.com/public/images/web/features/tools.svg" alt="">
                        </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 ">
                    <div class="text-icon-box relative mb50 center wow fadeInUp padding20 box-hover-1" data-wow-delay="0.2s">
                        <div class="box-img-icon features-box-icon">
                            <img src="http://www.digizigs.com/public/images/web/features/schedule.svg" alt="">
                        </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 ">
                    <div class="text-icon-box relative mb50 center wow fadeInUp padding20 box-hover-1" data-wow-delay="0.2s">
                        <div class="box-img-icon features-box-icon">
                            <img src="http://www.digizigs.com/public/images/web/features/quality.svg" alt="">
                        </div>
    ...
    <section id="blog">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="400ms">
                    <div class="post-thumb">
                      <a href="#"><img class="img-responsive" src="http://www.digizigs.com/public/images/web/blog/1.jpg" alt=""></a> 
                      <div class="post-meta">
                ...
                <div class="col-sm-4 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="800ms">
                    <div class="post-thumb">
                      <a href="#"><img class="img-responsive" src="http://www.digizigs.com/public/images/web/blog/3.jpg" alt=""></a>
                      <div class="post-meta">
                        <span><i class="fa fa-comments-o"></i> 3 Comments</span>
                        <span><i class="fa fa-heart"></i> 0 Likes</span> 
                      </div>
     ...
     <!--Contact-->
    <section id="contact" style="background: url(http://www.digizigs.com/public/images/web/contact/contact-bg.jpg);">
            ...
            <div class="container">
                ...
                <div class="contact-form wow fadeIn" data-wow-duration="1000ms" data-wow-delay="600ms">
                  <div class="row">
                    ...
                    <div class="col-sm-12">
                      <form id="main-contact-form" name="contact-form" method="post" action="http://www.digizigs.com/inquiry">
                        <input type="hidden" name="_token" value="OyIfppUAxfCfF3hELKJd5HlL37N4dIODcxtlO8GL">                        <div class="row  wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                          <div class="col-sm-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3 footer_widget">
                        <div class="inner">
                            ...
                            <div class="media">
                                <a href="#">
                                    <img src="http://www.digizigs.com/images\web\recent1.jpg" class="d-flex mr-3" alt="">
                                </a>
                            ...
                            <div class="media">
                                <a href="#">
                                    <img src="http://www.digizigs.com/images\web\recent2.jpg" class="d-flex mr-3" alt="">
                                </a>
                                <div class="media-body">
                                    <h5>
                                        <a href="#">Curling irons are as individual as the women</a>
                            ...
                            <div class="media">
                                <a href="#">
                                    <img src="http://www.digizigs.com/images\web\recent3.jpg" class="d-flex mr-3" alt="">
                                </a>
                                <div class="media-body">
                                    <h5>
                                        <a href="#">Curling irons are as individual as the women</a>
                    ...
                    <div class="col-md-6 col-lg-3 footer_widget">
                        <div class="inner">
                            ...
                            <h4>Newsletter</h4>
                                                            ...
                                                            <form action="http://www.digizigs.com/subscribe" class="nw_form" method="post">
                                    <input type="hidden" name="_token" value="OyIfppUAxfCfF3hELKJd5HlL37N4dIODcxtlO8GL">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="copyright-txt">
                            © 2018 <a href="http://www.digizigs.com">DigiZigs Web Technologies.</a> All Rights Reserved.
                        </div>
                    </div>
