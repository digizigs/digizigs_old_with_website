...
$("#fullscreen").on("click", function() {
    //$("#mobile-collapse i").toggleClass("fa fa-toggle-off"), $("#mobile-collapse i").toggleClass("fa fa-toggle-on")
    //alert('Full screen')
    $(window).height();
...
$(document).ready(function() {
    var e = ($(window), $("body")),
        t = e[0].className;
    $(".main-menu").attr("id", t), $(".card-header-right .close-card").on("click", function() {
        var e = $(this);
    ...
    $(".card-header-right .minimize-card").on("click", function() {
        ...
        $(this).toggleClass("fa fa-minus").fadeIn("slow"), $(this).toggleClass("fa fa-plus").fadeIn("slow")
    }), 
    $(".card-header-right .full-card").on("click", function() {
        var e = $(this);
        $(e.parents(".card")).toggleClass("full-card"), $(this).toggleClass("fa fa-arrows-alt"), $(this).toggleClass("fa fa-arrows")
    }), 
    ...
    $.mCustomScrollbar.defaults.axis = "yx", $("#styleSelector .style-cont").slimScroll({
        setTop: "10px",
    ...
    $(".pcoded-hasmenu").on("click", function() {
        ...
        //$(this).children('i').addClass('test');
        //$(this).find('>a>span>i').addClass("hover_triangle");
        //$(this).find('>a>has-submenu>i').toggleClass("fa fa-chevron-down"), 
        //$(this).find('>a>span>i').toggleClass("fa fa-chevron-right")
        //$(this>".has-submenu").addClass('test');
